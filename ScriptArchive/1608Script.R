...
barplot(rSedWater18SOTU$OTUnum,names.arg = rSedWater18SOTU$sample,col=c(2,4,5,7,8,10,11),las=2,ylim=c(0,1000),ylab="Number of OTUs")
...
barplot(rSedWaterCOIOTU$OTUnum,names.arg = rSedWaterCOIOTU$sample,col=c(2,4,5,7,8,10,11),las=2,ylim=c(0,3000),ylab="Number of OTUs")
...
summary(lm(OTUnum~cond*site,data=rSedWater18SOTU_r[rSedWater18SOTU_r$cond!="L",]))
...
#COI
##Linear model
summary(lm(OTUnum~cond*site,data=rSedWaterCOIOTU_r[rSedWaterCOIOTU_r$cond!="L",]))
##2-way anova
...
##Plot
pdf("../figures/SedWatertaxa.pdf",width=5,height=10)
